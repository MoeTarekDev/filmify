...
//       modules: [Navigation, Pagination, Mousewheel, Autoplay], // Add Autoplay module

//       slidesPerView: 1,
//       loop: true, // Ensure loop is enabled for continuous autoplay
...
//                     authPage === "signIn"
//                       ? "border-otherTextColor text-otherTextColor"
...
//                     name="email"
//                     type="email"
//                     className="bg-zinc-100 rounded-lg border-none text-black font-light p-3"
//                   />
//                 </div>
//                 <div className="flex flex-col gap-3">
//                   <span className="font-medium text-otherTextColor text-sm">
